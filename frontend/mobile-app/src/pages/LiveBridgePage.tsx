        ...
        <section className="rounded-2xl border bg-card p-4 shadow-sm">
          ...
          {sessionReady && access && <div className="mt-4 space-y-3">
            ...
            <div className="grid gap-2 sm:grid-cols-2">
              {access.can_review && access.review_ready && <button disabled={busy} className="rounded-xl border px-4 py-3 text-sm font-semibold disabled:opacity-50" onClick={() => void act('approve_review')}>Review bestätigen</button>}
              {access.can_review && access.review_rejection_ready && <button disabled={busy} className="rounded-xl border px-4 py-3 text-sm font-semibold disabled:opacity-50" onClick={() => void act('reject_review')}>Review ablehnen</button>}
