    ...
    <main className="min-h-screen bg-background text-foreground">
      <div className="mx-auto max-w-3xl space-y-4 px-4 py-5 pb-16">
        <header className="flex items-start justify-between gap-3">
          ...
          <div className="flex gap-2"><button className="rounded-lg border px-3 py-2 text-sm" onClick={() => setLocation('/address')}>Direktzugriff</button><button className="rounded-lg border px-3 py-2 text-sm" onClick={() => setLocation('/sources')}>Quellen</button><button className="rounded-lg border px-3 py-2 text-sm" onClick={() => setLocation('/cases')}>Fälle</button></div>
        </header>
